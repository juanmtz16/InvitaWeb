...
export default function Details() {
    ...
    const createParticles = () => {
      for (let i = 0; i < 40; i++) {
        particles.push({
          ...
          color: `rgba(219, 39, 119, ${Math.random() * 0.8 + 0.2})`, // rosa
  ...
  return (
    ...
    >
      ...
      <h2 className="relative z-10 text-4xl md:text-5xl font-bold text-pink-600 mb-8">
        Detalles del Evento
      </h2>

      <div className="relative z-10 max-w-3xl grid md:grid-cols-2 gap-10 text-gray-700">
        <div className="bg-white/70 p-6 rounded-2xl shadow-lg">
          <h3 className="text-xl font-semibold mb-2">Ceremonia</h3>
          <p>Iglesia San Miguel Arcángel</p>
          <p>17:00 hrs</p>
        </div>
        <div className="bg-white/70 p-6 rounded-2xl shadow-lg">
          <h3 className="text-xl font-semibold mb-2">Recepción</h3>
          <p>Salón Los Encantos</p>
          <p>19:00 hrs</p>
        </div>
        <div className="bg-white/70 p-6 rounded-2xl shadow-lg">
